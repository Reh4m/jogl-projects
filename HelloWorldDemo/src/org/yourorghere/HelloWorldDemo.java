...
/**
 * Instrucciones:
 * - Construir tres sólidos regulares de 8 caras (Octaedro).
 * - Cada uno debe estar inscrito en una esfera de diametro de máximo 2 unidades.
 * - Cada cara debe tener un color diferente.
 * - Cada sólido debe estar girando sobre su propio eje.
 * - Al arrastrar el mouse los tres deben girar en el eje 'x' y el eje 'y' dependiendo del movimiento del ratón.
 *
 * @author: emmarp.
 */

public class HelloWorldDemo implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public static void main(String[] args) {
        ...
        canvas.addGLEventListener(new HelloWorldDemo());
        frame.add(canvas);
